...
class _PharmacyCardState extends State<PharmacyCard>
  ...
  Widget build(BuildContext context) {
    ...
    return RepaintBoundary( // PERF FIX: Wrap card in RepaintBoundary to isolate repaints
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                // Pharmacy image/logo - PERF FIX: Use const Icon where possible
                RepaintBoundary( // PERF FIX: Isolate icon repaint
                  child: Container(
                    width: 64,
                    height: 64,
                    decoration: BoxDecoration(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          // Favorite button - PERF FIX: Extract to const where possible
                          GestureDetector(
                      ...
                      // Stats row - PERF FIX: Extract const widgets
                      Row(
                        children: [
                          // Status badge
                          Container(
